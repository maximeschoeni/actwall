<header class="header-bottom" id="header-bottom">
  ...
  <ul>
    <li class="active"><a href="<?php echo get_permalink($photo['id']); ?>" class="ellipsis"><span><?php echo $photo['title']; ?></span></a></li>
    <li><a href="<?php echo home_url('work-to-sale'); ?>?photographer=<?php echo $member->post_name; ?>"><span><?php echo __('All works', 'actwall'); ?></span></a></li>
    <li><a href="<?php echo get_permalink($member->ID); ?>"><span><?php echo __('Biography', 'actwall'); ?></span></a></li>
    <li class="follow">
      <a>
